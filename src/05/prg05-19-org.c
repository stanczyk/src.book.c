 ...
 *
 * Przykład zamieszczony w książce jako prg05-19
 * Kompiluje się przy użyciu gcc 11 i 12
 * Nie działa dla gcc 13
 */
#include <stdio.h>
...
int main (void)
{
	...
	int *(*wskFun2)()		// wskaźnik na funkcję zwracającą int *
		= fun2;
	int  (*wskFun3 [10])()	// tablica wskaźników na funkcje, zwracające int
		= { NULL, fun1 };
	printf("      Tab1 []     = {%d, %d, %d, ... }\n",      Tab1 [0],      Tab1 [1],      Tab1 [2]);
